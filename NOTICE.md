Portions of the code found in the [module.js](module.js) file originate from [unsoluble's SmallTime](https://github.com/unsoluble/smalltime) which is also licensed under MIT:
